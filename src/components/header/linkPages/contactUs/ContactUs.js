                  ...
                  <Card className=" rounded-4 py-4  px-3 contactus_bg">
                    <div className="row mx-auto">
                      ...
                      <div className="card_title mt-4">
                        ...
                        <div>
                          <button className="contact_btn px-3 w-100 py-2 rounded-2  mt-4 mb-2">
...
<Container>
<Col lg={10} className="modify_content align-self-center width_box_content mx-auto">
            <div  onClick={toggleDropdown}  className={` ${!isOpen ? "inactive rounded-2" : "active rounded-2"}`}>
            ...
            <div   onClick={toggletwo}  className={` ${!isTwo ? "inactive rounded-2  mt-md-3 mt-3" : "active rounded-2  mt-md-3 mt-3"}`}>
            ...
            <div  onClick={togglethree}  className={` ${!isThree ? "inactive rounded-2 mt-md-3 mt-3" : "active rounded-2 mt-md-3 mt-3"}`}>
            ...
            <div  onClick={togglefour}  className={` ${!isFour ? "inactive rounded-2 mt-md-3 mt-3" : "active rounded-2 mt-md-3 mt-3"}`} >
